 ...
 * @author Serkan ÖZAL
 */
public class DmaBasedPrimitiveFloatSerializer<T> extends AbstractDirectMemoryAccessBasedFieldAndDataSerializer<T, DirectMemoryAccessBasedOutputWriter> 
		implements DirectMemoryAccessBasedFieldSerializer<T>, DirectMemoryAccessBasedDataSerializer<T> {
		
	public DmaBasedPrimitiveFloatSerializer(Field field) {
		super(field);
	}
	
	public DmaBasedPrimitiveFloatSerializer(Class<T> clazz) {
		super(clazz);
	}
