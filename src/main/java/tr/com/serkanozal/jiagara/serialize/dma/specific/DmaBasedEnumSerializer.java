 ...
 * @author Serkan ÖZAL
 */
public class DmaBasedEnumSerializer<T> extends AbstractDirectMemoryAccessBasedFieldAndDataSerializer<T, DirectMemoryAccessBasedOutputWriter> 
		implements DirectMemoryAccessBasedFieldSerializer<T>, DirectMemoryAccessBasedDataSerializer<T> {
		
	public DmaBasedEnumSerializer(Field field) {
		super(field);
	}
	
	public DmaBasedEnumSerializer(Class<T> clazz) {
		super(clazz);
	}
