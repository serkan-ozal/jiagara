 ...
 * @author Serkan ÖZAL
 */
public class DmaBasedCollectionFieldSerializer<T> extends AbstractDmaBasedFieldSerializer<T, DirectMemoryAccessBasedOutputWriter> 
		implements DirectMemoryAccessBasedFieldSerializer<T> {
		
	public DmaBasedCollectionFieldSerializer(Field field) {
		super(field);
	}
	
	@Override
	public void serializeField(T obj, DirectMemoryAccessBasedOutputWriter outputWriter) {
		// TODO Implements collection field serializer
	}
