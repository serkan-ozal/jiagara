 ...
 * @author Serkan ÖZAL
 */
public class DmaBasedShortFieldSerializer<T> extends AbstractDmaBasedFieldSerializer<T, DirectMemoryAccessBasedOutputWriter> 
		implements DirectMemoryAccessBasedFieldSerializer<T> {
		
	public DmaBasedShortFieldSerializer(Field field) {
		super(field);
	}
