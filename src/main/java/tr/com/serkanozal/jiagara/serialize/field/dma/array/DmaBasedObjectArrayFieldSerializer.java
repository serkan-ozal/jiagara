 ...
 * @author Serkan ÖZAL
 */
public class DmaBasedObjectArrayFieldSerializer<T> extends AbstractDmaBasedFieldSerializer<T, DirectMemoryAccessBasedOutputWriter> 
		implements DirectMemoryAccessBasedFieldSerializer<T> {
	
	public DmaBasedObjectArrayFieldSerializer(Field field) {
		super(field);
	}
	
	@Override
	public void serializeField(T obj, DirectMemoryAccessBasedOutputWriter outputWriter) {
		outputWriter.writeObjectArray(obj, fieldOffset);
	}
