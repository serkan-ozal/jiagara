 ...
 * @author Serkan ÖZAL
 */
public class DmaBasedObjectFloatSerializer<T> extends AbstractDirectMemoryAccessBasedSerializer<T, DirectMemoryAccessBasedOutputWriter> 
	...
	public void serializeField(T obj, DirectMemoryAccessBasedOutputWriter outputWriter) {
		Float floatField = unsafe.getFloat(obj, fieldOffset);
		if (floatField == null) {
			outputWriter.writeNull();
		}
		else {
			outputWriter.writeFloat(floatField, valueFieldOffset);
		}	
	}
