 ...
 * @author Serkan ÖZAL
 */
public class DmaBasedByteArrayFieldSerializer<T> extends AbstractDmaBasedFieldSerializer<T, DirectMemoryAccessBasedOutputWriter> 
		implements DirectMemoryAccessBasedFieldSerializer<T> {
	
	public DmaBasedByteArrayFieldSerializer(Field field) {
		super(field);
	}
