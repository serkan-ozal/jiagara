 ...
 * @author Serkan ÖZAL
 */
public class DirectMemoryAccessBasedSerializerFactory 
	...
	public <T> DirectMemoryAccessBasedFieldSerializer<T> createFieldSerializer(
			Field field) {
		return directMemoryAccessBasedFieldSerializerFactory.createFieldSerializer(field);
	}

	@Override
	public <T> DirectMemoryAccessBasedDataSerializer<T> createDataSerializer(
			Class<T> clazz) {
		return directMemoryAccessBasedDataSerializerFactory.createDataSerializer(clazz);
	}
