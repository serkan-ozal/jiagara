 ...
 * @author Serkan ÖZAL
 */
public class DmaBasedShortArrayFieldSerializer<T> extends AbstractDmaBasedFieldSerializer<T, DirectMemoryAccessBasedOutputWriter> 
		implements DirectMemoryAccessBasedFieldSerializer<T> {
	
	public DmaBasedShortArrayFieldSerializer(Field field) {
		super(field);
	}
