 ...
 * @author Serkan ÖZAL
 */
public class DmaBasedDoubleArrayFieldSerializer<T> extends AbstractDmaBasedFieldSerializer<T, DirectMemoryAccessBasedOutputWriter> 
		implements DirectMemoryAccessBasedFieldSerializer<T> {
	
	public DmaBasedDoubleArrayFieldSerializer(Field field) {
		super(field);
	}
