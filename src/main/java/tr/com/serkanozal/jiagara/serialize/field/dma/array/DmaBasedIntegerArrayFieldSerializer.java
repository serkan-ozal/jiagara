 ...
 * @author Serkan ÖZAL
 */
public class DmaBasedIntegerArrayFieldSerializer<T> extends AbstractDmaBasedFieldSerializer<T, DirectMemoryAccessBasedOutputWriter> 
		implements DirectMemoryAccessBasedFieldSerializer<T> {
	
	public DmaBasedIntegerArrayFieldSerializer(Field field) {
		super(field);
	}
