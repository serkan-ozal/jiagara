 ...
 * @author Serkan ÖZAL
 */
public class DmaBasedIntegerFieldSerializer <T> extends AbstractDmaBasedFieldSerializer<T, DirectMemoryAccessBasedOutputWriter> 
		implements DirectMemoryAccessBasedFieldSerializer<T> {
		
	public DmaBasedIntegerFieldSerializer(Field field) {
		super(field);
	}
