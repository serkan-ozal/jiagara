 ...
 * @author Serkan ÖZAL
 */
public class DmaBasedFloatArrayFieldSerializer<T> extends AbstractDmaBasedFieldSerializer<T, DirectMemoryAccessBasedOutputWriter>  
		implements DirectMemoryAccessBasedFieldSerializer<T> {
	
	public DmaBasedFloatArrayFieldSerializer(Field field) {
		super(field);
	}
