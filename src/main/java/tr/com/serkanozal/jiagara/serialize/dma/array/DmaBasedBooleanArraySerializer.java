 ...
 * @author Serkan ÖZAL
 */
public class DmaBasedBooleanArraySerializer<T> extends AbstractDirectMemoryAccessBasedFieldAndDataSerializer<T, DirectMemoryAccessBasedOutputWriter> 
		implements DirectMemoryAccessBasedFieldSerializer<T>, DirectMemoryAccessBasedDataSerializer<T> {
	
	public DmaBasedBooleanArraySerializer(Field field) {
		super(field);
	}
	
	public DmaBasedBooleanArraySerializer(Class<T> clazz) {
		super(clazz);
	}
