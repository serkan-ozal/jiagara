 ...
 * @author Serkan ÖZAL
 */
public class DmaBasedPrimitiveLongArraySerializer<T> extends AbstractDirectMemoryAccessBasedFieldAndDataSerializer<T, DirectMemoryAccessBasedOutputWriter> 
		implements DirectMemoryAccessBasedFieldSerializer<T>, DirectMemoryAccessBasedDataSerializer<T> {
	
	public DmaBasedPrimitiveLongArraySerializer(Field field) {
		super(field);
	}
	
	public DmaBasedPrimitiveLongArraySerializer(Class<T> clazz) {
		super(clazz);
	}
	
	@Override
	public void serializeField(T obj, DirectMemoryAccessBasedOutputWriter outputWriter) {
		outputWriter.writeLongArray(obj, fieldOffset);
	}
	...
	public void serializeDataContent(T obj, DirectMemoryAccessBasedOutputWriter outputWriter) {
		...
		if (array == null) {
			...
			outputWriter.writeLongArray(address);
		}
	}
