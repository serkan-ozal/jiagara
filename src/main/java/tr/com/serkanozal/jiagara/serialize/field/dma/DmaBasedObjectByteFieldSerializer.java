 ...
 * @author Serkan ÖZAL
 */
public class DmaBasedObjectByteFieldSerializer extends AbstractFieldSerializer<DirectMemoryAccessBasedOutputWriter> 
		implements DirectMemoryAccessBasedFieldSerializer {
		
	public DmaBasedObjectByteFieldSerializer(Field field) {
		super(field);
	}
