 ...
 * @author Serkan ÖZAL
 */
public class DataSerializerConfigBeanBuilder implements Builder<DataSerializerConfigBean> {

	private Class<?> clazz;
	@SuppressWarnings("rawtypes")
	private Class<? extends DataSerializer> dataSerializerClass;

	public DataSerializerConfigBeanBuilder clazz(Class<?> clazz) {
		this.clazz = clazz;
		return this;
	}
	
	@SuppressWarnings("rawtypes")
	public DataSerializerConfigBeanBuilder dataSerializerClass(Class<? extends DataSerializer> dataSerializerClass) {
		this.dataSerializerClass = dataSerializerClass;
		return this;
	}
	
	@Override
	public DataSerializerConfigBean build() {
		return new DataSerializerConfigBean(clazz, dataSerializerClass);
	}
